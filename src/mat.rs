...
pub trait Material {
    fn shade<'a>( &self, in_ray: &Ray, col: Box<dyn Collision + 'a>, accel_struct: &AccelStruct, scene: &Scene, iter: u8 ) -> Vec3;
}

pub struct NormalMaterial;
impl Material for NormalMaterial {
    fn shade<'a>( &self, in_ray: &Ray, col: Box<dyn Collision+'a>, _: &AccelStruct, _: &Scene, _: u8 ) -> Vec3 {
        col.normal(in_ray)
    }
}
...
pub struct Emissive {
    ...
    fn shade<'a>( &self, ray: &Ray, col: Box<dyn Collision+'a>, _: &AccelStruct, _: &Scene, _: u8 ) -> Vec3 {
    ...
    fn shade<'a>( &self, in_ray: &Ray, col: Box<dyn Collision+'a>, accel_struct: &AccelStruct, scene: &Scene, iter: u8 ) -> Vec3 {
        ...
        for _ in 0..64 {
            ...
            if col.is_some() {
                ...
                let new_light = scene.mats[col.mat()].shade(&out_ray,col,accel_struct,scene,iter-1);
